-- http://www.dwhworld.com/2010/08/date-dimension-sql-scripts-mysql/
...
SELECT number, DATE_ADD( '1949-12-31', INTERVAL number DAY )
FROM numbers
WHERE DATE_ADD( '1949-12-31', INTERVAL number DAY ) BETWEEN '1949-12-31' AND '2020-12-31'
ORDER BY number;
